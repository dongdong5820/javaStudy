...
/**
 * @author ranlay.su
 * @date 2021-06-15 20:42
 * @desc 抓取网页小程序
 */
public class GetHtmlContentAppMain {
    private static final String DOMAIN = "www.jtthink.com";
    ...
    public static void main(String[] args) throws IOException {
        ...
        Socket s = new Socket();
        InetSocketAddress sa = new InetSocketAddress(inetAddress, PORT);
        s.connect(sa, 10000);
