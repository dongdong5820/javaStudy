 ...
 * @desc
 */
public class InterruptedThreadAppMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // TODO sleep的时候烦人的 InterruptedException到底是什么
...
//            thread.stop();
        ...
        System.out.println("interrupt 线程结束，继续 sleep 五秒钟");

        // TODO 使用 TimeUnit可以方便进行时间单位之间的换算
        Thread.sleep(TimeUnit.SECONDS.toMillis(5));
